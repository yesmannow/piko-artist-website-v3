...
import { Home, User, Video, MoreVertical, Music, Mail, X, Instagram, Youtube, ExternalLink, Radio } from "lucide-react";
...
/** Pill that appears when a track is currently playing */
function NowPlayingPill({ handleClick }: { handleClick: () => void }) {
...
/** A single nav item button in the bottom tray */
...
/** Social icons row inside the More drawer */
...
/** The "More" slide-up drawer content */
        ...
        <>
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-6 pb-6">
                  ...
                  return (
                    <Link
                      ...
                      className={`flex items-center gap-4 px-4 py-3 rounded-lg border-2 transition-all touch-manipulation ${
                        active
                          ? ('isStudio' in item && item.isStudio)
                            ? "bg-[#00f2ff]/15 text-[#00f2ff] border-[#00f2ff] shadow-[0_0_15px_rgba(0,242,255,0.3)]"
              ...
              {/* Secondary Actions */}
              <DrawerSecondaryActions handleClick={handleClick} setIsMoreOpen={setIsMoreOpen} />
            </div>
          </motion.div>
        </>
      )}
...
/** Secondary action buttons (Book/Contact, Press Kit) in the More drawer */
function DrawerSecondaryActions({
  handleClick,
  setIsMoreOpen,
}: {
  handleClick: () => void;
...
/** The "About Piko" long-press panel */
function AboutPikoPanel({
  isAboutOpen,
  setIsAboutOpen,
  handleClick,
}: {
...
export function MobileNav() {
  ...
  return (
    <>
      <NowPlayingPill handleClick={handleClick} />
      ...
      >
        <div className="flex items-center h-16 px-2 min-h-[44px] gap-2">
          ...
          <div className="flex items-center justify-end flex-1 gap-1">
            ...
            {/* More Button */}
            <MoreButton isMoreOpen={isMoreOpen} handleMoreClick={handleMoreClick} />
...
/** The More toggle button in the bottom tray */
function MoreButton({
  isMoreOpen,
  handleMoreClick,
}: {
