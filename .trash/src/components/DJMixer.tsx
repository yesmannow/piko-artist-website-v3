  ...
  return (
    <div className="flex flex-col gap-4 md:gap-6 p-4 md:p-6 bg-[#0a0a0a] rounded-lg border border-gray-800 shadow-lg">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
        {/* Left Strip - Deck A */}
        <div
          className="flex flex-col items-center gap-4 p-4 bg-[#1a1a1a]/50 rounded-lg border border-gray-800/50"
          data-tour="mixer-deck-a"
        >
          ...
          <div className="flex gap-2 md:gap-3 justify-center flex-wrap">
            <div className="flex flex-col items-center gap-1">
              <div className="text-[10px] md:text-xs font-barlow uppercase text-red-500 font-bold mb-1">
                HIGH
              </div>
              <Knob
                value={deckAHigh}
            ...
            <div className="flex flex-col items-center gap-1">
              <div className="text-[10px] md:text-xs font-barlow uppercase text-green-500 font-bold mb-1">
                MID
              </div>
              <Knob
                value={deckAMid}
            ...
            <div className="flex flex-col items-center gap-1">
              <div className="text-[10px] md:text-xs font-barlow uppercase text-blue-500 font-bold mb-1">
                LOW
              </div>
              <Knob
                value={deckALow}
            ...
            <div className="bg-[#0a0a0a] rounded border border-gray-800/50 p-3 flex flex-col items-center gap-3">
              ...
              <div className="flex items-center gap-3 mt-1">
                ...
                <div className="flex items-center gap-1">
                  {(["default", "high-contrast", "oled"] as const).map(
                    (opt) => (
                      <button
                        key={opt}
              ...
              <div className="bg-[#0a0a0a] rounded border border-gray-800/50 p-3 w-full">
                ...
                {isRecording && (
                  <div className="flex items-center gap-2 text-xs text-red-500 font-barlow">
                    ...
                    RECORDING{" "}
                    {recordingDuration > 0 && `(${recordingDuration}s)`}
                  </div>
                )}
                {recordingError && (
            ...
            >
              ...
              <div className="bg-[#0a0a0a] rounded border border-gray-800/50 p-3 w-full">
                <div className="flex items-center gap-2 w-full max-w-full">
                  <span className="text-[10px] text-gray-500 font-barlow">
                    -12
                  </span>
                  <input
                    type="range"
                    ...
                    onChange={(e) =>
                      onLimiterThresholdChange(parseFloat(e.target.value))
                    }
